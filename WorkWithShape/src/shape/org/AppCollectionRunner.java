...
public class AppCollectionRunner {
	...
	public static void main(String[] args) {
		...
		logger.info(maxShapes.getClass().getSimpleName() + " maxShape has area" + maxShapes.getArea());
		logger.info(minShapes.getClass().getSimpleName() + " minShape has area" + minShapes.getArea());
	}
}
